[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/recruitment-ai-mcp.html)
...
- "Use `generate_job_description` to …"
- "Use `score_cv` to …"
- "Use `generate_interview_questions` to …"
